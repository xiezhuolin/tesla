...
import cn.acewill.pos.next.ui.fragment.LanguageFragment;
...
//        comTextViewList.add(tableSet);
        ...
        comTextViewList.add(languageSet);
...
//                break;
            ...
            case 5:
                ...
                ft.replace(R.id.set_content, languageFragment);
                break;
//            case 6:
//                setSelect(6);
...
//                break;
    ...
    private void setViewState(int selectIndex) {
        ...
        for (int i = 0; i < size; i++) {
            comTextViewList.get(tempIndex).setBackgroundColor(resources.getColor(R.color.dishkind_bg_gray));
            comTextViewList.get(selectIndex).setBackgroundColor(resources.getColor(R.color.white));
...
//                break;
    ...
    @OnClick( {R.id.rel_back, R.id.about_set, R.id.my_store, R.id.print_kds, R.id.senior_set, R.id.scan_set,R.id.language_set/*, R.id.table_set,R.id.help_set*/} )
...
//                break;
            ...
            case R.id.language_set:
                ToolsUtils.writeUserOperationRecords("切换语言界面");
                changeTab(5);
                break;
//            case R.id.help_set:
