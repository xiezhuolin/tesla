 ...
 */
public class PrintSetAdapter extends BaseAdapter {
    private BtnOnClickListener callback;
    public PrintSetAdapter(Context context, BtnOnClickListener callback) {
        super(context);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.print_type.setText(ReceiptsDataController.receiptType2sth(printer));

        holder.print_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onClick(Constant.DialogStyle.DELETE_PRINTER,position);
//                MyApplication.getInstance().ShowToast("删除");
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callback.onClick(Constant.DialogStyle.MODIFY_PRINTER,position);
