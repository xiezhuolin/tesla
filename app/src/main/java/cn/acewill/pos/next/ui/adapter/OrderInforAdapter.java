...
public class OrderInforAdapter extends BaseAdapter {
    private boolean isShowDo = true;
    public OrderInforAdapter(Context context) {
        super(context);
    }

    public void setShowDo(boolean isShowDo)
    {
        this.isShowDo = isShowDo;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_order_infor, null);
        ...
        if(isShowDo)
        {
            holder.rel_do.setVisibility(View.VISIBLE);
        }
        else{
            holder.rel_do.setVisibility(View.GONE);
        }
