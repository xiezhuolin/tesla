...
public class DialogUtil {
    ...
    public static void loginSetDialog(final Context context) {
        ...
        final RelativeLayout rel_bindInfo = (RelativeLayout) dialog.findViewById(R.id.rel_bindInfo);
        final CommonEditText login_server = (CommonEditText) dialog.findViewById(R.id.login_server);
        final CommonEditText login_port = (CommonEditText) dialog.findViewById(R.id.login_port);
        final CommonEditText login_server_jyj = (CommonEditText) dialog.findViewById(R.id.login_server_jyj);
        final CommonEditText login_port_jyj = (CommonEditText) dialog.findViewById(R.id.login_port_jyj);
        final CommonEditText kds_address = (CommonEditText) dialog.findViewById(R.id.kds_address);
        ...
        final CommonEditText device_name = (CommonEditText) dialog.findViewById(R.id.device_name);
        final CheckBox ck_select_dish = (CheckBox) dialog.findViewById(R.id.ck_select_dish);
        final CheckBox ck_select_netorder = (CheckBox) dialog.findViewById(R.id.ck_select_netorder);
        final CheckBox ck_select_kit_money = (CheckBox) dialog.findViewById(R.id.ck_select_kit_money);
        ...
        if (StoreInfor.terminalInfo != null) {
            ...
            String storeInfo = "品牌名称:" + terminalInfo.brandName + "\t门店名称:" + terminalInfo.sname + "\t本机唯一绑定标识:" + store.getTenTokenStr();
    ...
    public static Dialog scanDialog(final Context context, final int type, final EPayTask inTask, final DialogCallBack callBack) {
        ...
        String str = type == 1 ? ToolsUtils.returnXMLStr("sth_zfb") : ToolsUtils.returnXMLStr("sth_wx");
        if (type == 12) {
        ...
        scan_title.setText(ToolsUtils.returnXMLStr("guest") + str + ToolsUtils.returnXMLStr("scan_pos_qrcode"));
        ...
        msg.setText(ToolsUtils.returnXMLStr("wait_pay_please_wating") + "(" + num[0] + ToolsUtils.returnXMLStr("second") + ")");
    ...
    public static Dialog scanPadDialog(final Context context, final int type, final EPayTask inTask, final String qrCodeUrl, final Bitmap qrCodeBit, final InterfaceDialog interfaceDialog) {
        ...
        final String title = ToolsUtils.returnXMLStr("guest") + str + ToolsUtils.returnXMLStr("scan_pos_qrcode");
    ...
    public static Dialog initTableInfo(final Context context, final DialogTCallback dialogCallback) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_table_info, 0.5f, 0.3f);
        final CommonEditText ed_tableNumber = (CommonEditText) dialog.findViewById(R.id.ed_tableNumber);
        final CommonEditText ed_peopleNums = (CommonEditText) dialog.findViewById(R.id.ed_peopleNums);
        TextView print_ok = (TextView) dialog.findViewById(R.id.print_ok);
        TextView print_cancle = (TextView) dialog.findViewById(R.id.print_cancle);
        LinearLayout print_close_ll = (LinearLayout) dialog.findViewById(R.id.print_close_ll);
        ...
        print_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(tableNumber)) {
                    MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_input_tableNumber"));
                } else {
        ...
        print_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(sth)) {
                    MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_enter_it_correctly"));
                } else if (!TextUtils.isEmpty(sth)) {
                    if (maxNums != 0) {
                        int num = Integer.valueOf(sth);
                        if (num > maxNums) {
                            MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("select_dish_person_more_is_select_person"));
                        } else if (num == maxNums) {
                            dialogEtCallback.onConfirm(sth);
                            finalDialog.dismiss();
                        }
    ...
    public static Dialog inputDoubleDialog(final Context context, final String titleStr, final String oneLineStr, final String twoLineStr, final DialogTCallback dialogTCallback) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_double_simple, 0.5f, 0.5f);
        dialog.setCanceledOnTouchOutside(false);
        ...
        if (twoLineStr.contains(ToolsUtils.returnXMLStr("string_login_pwd")) || twoLineStr.contains("password")) {
            ed_twoStr.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
        } else {
        ...
        tv_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edOneLineStr)) {
                    MyApplication.getInstance().ShowToast(oneLineStr + ToolsUtils.returnXMLStr("not_is_null"));
                    return;
                }
                if (TextUtils.isEmpty(edTwoLineStr)) {
                    MyApplication.getInstance().ShowToast(twoLineStr + ToolsUtils.returnXMLStr("not_is_null"));
                    return;
                }
                User user = new User();
    ...
    public static Dialog reserveDialog(final Context context, final DialogTCallback dialogTCallback) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_reserve_info, 0.7f, 0.5f);
    ...
    public static Dialog printerStateDialog(final Context context) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_printer_state, 0.8f, 0.8f);
        dialog.setCanceledOnTouchOutside(false);
        ...
        lin_print_state.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_line_state.setBackgroundColor(context.getResources().getColor(R.color.title_text_color));

                print_record.setTextColor(context.getResources().getColor(R.color.main_order_item_bg));
                tv_line_record.setBackgroundColor(context.getResources().getColor(R.color.transform));
        ...
        lin_print_record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                print_state.setTextColor(context.getResources().getColor(R.color.main_order_item_bg));
                tv_line_state.setBackgroundColor(context.getResources().getColor(R.color.transform));

                print_record.setTextColor(context.getResources().getColor(R.color.title_text_color));
                tv_line_record.setBackgroundColor(context.getResources().getColor(R.color.title_text_color));
            }
        });
    ...
    public static Dialog changeAccountDialog(final Context context, final DialogTCallback dialogTCallback) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_change_account, 0.7f, 0.5f);
        final Calendar calendar = Calendar.getInstance();
        dialog.setCanceledOnTouchOutside(false);
        TextView tv_back = (TextView) dialog.findViewById(R.id.tv_back);
        TextView tv_ok = (TextView) dialog.findViewById(R.id.tv_ok);
    ...
    public static Dialog reservePlaceDialog(final Context context, List<Reserve> reserveList, final DialogTCallback dialogTCallback) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_reserve_place, 0.8f, 0.5f);
        dialog.setCanceledOnTouchOutside(false);
        TextView tv_back = (TextView) dialog.findViewById(R.id.tv_back);
    ...
    public static Dialog rushDishDialog(final Context context, final String title, final List<OrderItem> orderItems, int sectionsStyle, final DialogCallback dialogCallback) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_rush_item, 0.7f, 0.7f, 1);
        TextView tv_back = (TextView) dialog.findViewById(R.id.tv_back);
        TextView tv_add = (TextView) dialog.findViewById(R.id.tv_add);
        TextView tv_title = (TextView) dialog.findViewById(R.id.tv_title);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (printer != null) {
                    if (printer.isSelect) {
                        ...
                        ToolsUtils.writeUserOperationRecords("取消选择" + printer.getDeviceName() + "按钮");
                    } else {
    ...
    public static Dialog turnTableDialog(final Context context, final String title, final int table_type, List<TableInfor> allTableInfor, final DialogTCallback dialogTCallback) {
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_empty_table, 0.7f, 0.7f, 1);
        dialog.setCanceledOnTouchOutside(false);
        TextView tv_back = (TextView) dialog.findViewById(R.id.tv_back);
        TextView tv_add = (TextView) dialog.findViewById(R.id.tv_add);
        TextView tv_title = (TextView) dialog.findViewById(R.id.tv_title);
        ...
        handleGv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (Constant.TABLE_TURN == table_type) {
                    ...
                    if (tableInfor[0] != null && tableInfor[0].getStatus() == TableStatus.IN_USE)//使用
                    {
                        tableAdapter.setSelectIndex(position);
                    } else {
    ...
    public static Dialog takeOutDialog(final Context context, final DialogTCallback dialogTCallback) {
        ...
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_take_out, 0.9f, 0.9f);
        final Calendar calendar = Calendar.getInstance();
        dialog.setCanceledOnTouchOutside(false);
        TextView tv_back = (TextView) dialog.findViewById(R.id.tv_back);
        TextView tv_ok = (TextView) dialog.findViewById(R.id.tv_ok);
    ...
    public static Dialog cardRecordDialog(final Context context, final DialogTCallback dialogTCallback) {
        ...
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_cardrecord, 0.7f, 0.5f);
        final Calendar calendar = Calendar.getInstance();
        dialog.setCanceledOnTouchOutside(false);
        TextView tv_back = (TextView) dialog.findViewById(R.id.tv_back);
        TextView tv_ok = (TextView) dialog.findViewById(R.id.tv_ok);
    ...
    public static Dialog ordinaryDialog(final Context context, final String title, final String content, final DialogCallback dialogCallback) {
        ...
        tv_content.setText(TextUtils.isEmpty(content) ? ToolsUtils.returnXMLStr("text_app_version_hine") : content);
    ...
    public static Dialog meiTuanDialog(final Context context, final Long orderId, final BigDecimal money, final boolean isCheckOut, CopyOnWriteArrayList<ValidationResponse> addValidationLists, final DialogMTCallback dialogMTCallback) {
        final double totalMoney = Double.valueOf(money.toString());
        ...
        final TextView tv_not_pay_price = (TextView) dialog.findViewById(R.id.tv_not_pay_price);
        ...
        final ScrolListView ticket_list = (ScrolListView) dialog.findViewById(R.id.ticket_list);
        ...
        class MTVouchersAdp extends BaseAdapter {
            ...
            public void addValidation(ValidationResponse validation) {
                ...
                for (int i = 0; i < dataSize; i++) {
                    ...
                    if (dataList.get(i) != null) {
                        if (dataList.get(i).getOperateType() == 2 || dataList.get(i).getOperateType() == 3) {
                ...
                if (validation.isSuccess() && validation.vouchersIsEff()) {
                    if (validationSuccSize == 0) {
                        ...
                        if (validationSuccSize >= maxVouchersNums[0]) {
                            MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("voucher_is_max"));
                            return;
                        }
                    ...
                    if (validation.getOperateType() == 2) //是一个可删除的项
                    {
                        ...
                        MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("voucher_info_error"));
                    }
                }
            }
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = LayoutInflater.from(context).inflate(R.layout.meituan_add_view, null);
                    holder.voucherCodeEd = (CommonEditText) convertView.findViewById(R.id.voucherCode);
                    holder.lin_voucher_info = (LinearLayout) convertView.findViewById(R.id.lin_voucher_info);
                    ...
                    holder.tv_min_voucher = (TextView) convertView.findViewById(R.id.tv_min_voucher);
                    holder.tv_ver_eff_time = (TextView) convertView.findViewById(R.id.tv_ver_eff_time);
                    holder.tv_max_voucher = (TextView) convertView.findViewById(R.id.tv_max_voucher);
                ...
                if (validation != null) {
                    ...
                    holder.tv_min_voucher.setText(validation.getMinConsume() + " " + ToolsUtils.returnXMLStr("leaf"));
                    holder.tv_max_voucher.setText(validation.getCount() + " " + ToolsUtils.returnXMLStr("leaf"));
        ...
        class VoucherCode implements ScanGunKeyEventHelper.OnScanSuccessListener {
            ...
            public void getVoucherInfo(final String num) {
                try {
                    ...
                    storeBusinessService.validationSetout(num, new ResultCallback<ValidationResponse>() {
                        @Override
                        public void onResult(ValidationResponse result) {
                            ...
                            if (result.isSuccess()) {
                                wsh_warn.setVisibility(View.GONE);
                                //如何第0项是初始项的话
                                if (mtVouchersAdp.getValidation(0) != null && mtVouchersAdp.getValidation(0).getOperateType() == 3) {
                                ...
                                if (addTicketList != null && addTicketList.size() > 0) {
                                    if (addTicketList.contains(result.getCouponCode())) {
                                        MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("voucher_info_existing"));
                                        return;
                                    }
                                }
            ...
            public void executeCode() {
                wsh_warn.setVisibility(View.GONE);
                progressDialog.showLoading("");
                storeBusinessService.executeCode(mtVouchersAdp.getVoucherStr(), orderId, new ResultCallback<ValidationResponse>() {
                    @Override
                    public void onResult(ValidationResponse result) {
                        progressDialog.disLoading();
                        if (result.isSuccess()) {
                            dialog.dismiss();
                            wsh_warn.setVisibility(View.GONE);
                            dialogMTCallback.onCheckout(new BigDecimal(mtVouchersAdp.getVouchersMoney()).setScale(2, BigDecimal.ROUND_HALF_UP), isCheckOut, addValidationList);
                        } else {
                            wsh_warn.setVisibility(View.VISIBLE);
        ...
        query.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mtVouchersAdp.getCurrentEditView() != null) {
                    final String num = mtVouchersAdp.getCurrentEditView().getText().toString().trim();
                    if (TextUtils.isEmpty(num)) {
                        MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_input_voucher_code"));
                        return;
                    }
                    if (addTicketList != null && addTicketList.size() > 0) {
            ...
            public void onClick(View v) {
                if (isCheckOut) {
                    ...
                    if (addValidationList != null && addValidationList.size() > 0) {
                        ...
                        MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_select_at_least_one_coupon"));
                    }
                }
            }
        });
    ...
    public static Dialog memberDialog(final Context context, final int typeid, final BigDecimal money, final List<OrderItem> orderItems, final boolean isCheckBalance, final CreatDealBack creatDealBack) {
        ...
        final BigDecimal memberMoney = ToolsUtils.cloneTo(money.setScale(2, BigDecimal.ROUND_DOWN));
        ...
        final ComTextView wsh_title = (ComTextView) dialog.findViewById(R.id.wsh_title);
        final ComTextView wsh_close = (ComTextView) dialog.findViewById(R.id.wsh_close);
        final CommonEditText cardno = (CommonEditText) dialog.findViewById(R.id.cardno);
        final TextView checkmember = (TextView) dialog.findViewById(R.id.checkmember);
        ...
        final TextView cancel_saveMember = (TextView) dialog.findViewById(R.id.cancel_saveMember);
        TextView cancle = (TextView) dialog.findViewById(R.id.cancle);
        TextView use = (TextView) dialog.findViewById(R.id.use);
        final TextView wsh_warn = (TextView) dialog.findViewById(R.id.wsh_warn);
        final LinearLayout wsh_info_ll = (LinearLayout) dialog.findViewById(R.id.wsh_info_ll);
        final ListView couponList = (ListView) dialog.findViewById(R.id.couponList);
        final LinearLayout coupon_ll = (LinearLayout) dialog.findViewById(R.id.coupon_ll);
        final RelativeLayout balance_ll = (RelativeLayout) dialog.findViewById(R.id.balance_ll);
        final TextView tv_balance_hine = (TextView) dialog.findViewById(R.id.tv_balance_hine);
        final TextView tv_credit_hine = (TextView) dialog.findViewById(R.id.tv_credit_hine);
        final TextView tv_sure = (TextView) dialog.findViewById(R.id.tv_sure);
        final TextView member_info = (TextView) dialog.findViewById(R.id.member_info);
        final TextView tv_coupon_hine = (TextView) dialog.findViewById(R.id.tv_coupon_hine);
        final TextView order_money = (TextView) dialog.findViewById(R.id.order_money);
        final ScrolListView lv_memberCard = (ScrolListView) dialog.findViewById(R.id.lv_memberCard);
        final RelativeLayout credit_ll = (RelativeLayout) dialog.findViewById(R.id.credit_ll);
        final RelativeLayout rel_selectMemberCard = (RelativeLayout) dialog.findViewById(R.id.rel_selectMemberCard);
        ...
        class MemberPay {
            public void logicPay(List dataList, boolean isCreditOpen, boolean isStoredOpen) {
                if (accountMemberInfo[0] != null) {
                    ...
                    if (accountMemberInfo[0].getCredit() != null && accountMemberInfo[0].isUsecredit() && isCreditOpen) {
                        userCredit = new BigDecimal(accountMemberInfo[0].getCredit());
                    }
                    //用户的储值金额
                    BigDecimal userStored = new BigDecimal("0.00");
                    if (isStoredOpen) {
                        userStored = new BigDecimal(accountMemberInfo[0].getBalance() / 100.0).setScale(2, BigDecimal.ROUND_DOWN);
                    }
                    //用户使用券的金额
                    ...
                    if (userCoupon.compareTo(BigDecimal.ZERO) > 0) {
                        ...
                        order_money.setText(ToolsUtils.returnXMLStr("wating_pay_money") + userNeedPay);
                    ...
                    if (!userIsPayEnd) {
                        ...
                        if (userCredit.compareTo(BigDecimal.ZERO) > 0) {
                            ...
                            if (userNeedPay.compareTo(userCredit) == 0) {
                                userNeedPay = new BigDecimal("0.00");
                                order_money.setText(ToolsUtils.returnXMLStr("wating_pay_money") + decimal);
                                ckSelectBalance.setChecked(false);
                                tv_pay_balance.setVisibility(View.GONE);
                                ckSelectCredit.setChecked(true);
                                tv_pay_credit.setVisibility(View.VISIBLE);
                                tv_pay_credit.setText(ToolsUtils.returnXMLStr("pay_intergral") + userCredit);
                            ...
                            //需要支付的金额小于用户的积分
                                ...
                                ckSelectCredit.setChecked(true);
                                tv_pay_credit.setVisibility(View.VISIBLE);
                                tv_pay_credit.setText(ToolsUtils.returnXMLStr("pay_intergral") + userNeedPay);
                                userNeedPay = new BigDecimal("0.00");
                            }
                            //需要支付的金额大于用户的积分
                            else if (userNeedPay.compareTo(userCredit) == 1) {
                                userNeedPay = userNeedPay.subtract(userCredit);
                                order_money.setText(ToolsUtils.returnXMLStr("wating_pay_money") + decimal.add(userNeedPay));
                                ckSelectBalance.setChecked(false);
                                tv_pay_balance.setVisibility(View.GONE);
                                ckSelectCredit.setChecked(true);
                                tv_pay_credit.setVisibility(View.VISIBLE);
                    ...
                    if (!userIsPayEnd) {
                        ...
                        if (userStored.compareTo(BigDecimal.ZERO) > 0) {
                            ...
                            if (!userIsPayEnd) {
                                ...
                                tv_pay_balance.setText(ToolsUtils.returnXMLStr("paid2") + userStored);
                            }
                        }
                    }
                    if (!isCreditOpen) {
                    ...
                    if (!userIsPayEnd) {
                        ...
                        if (isCheckBalance) {
                            if (userNeedPay.compareTo(BigDecimal.ZERO) > 0) {
                                MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("member_pay_money_error"));
                            }
                        }
                    }
                }
                        ...
                        public void onResult(final List<Account> result) {
                            ...
                            if (result != null && result.size() > 0) {
                                if (result.size() == 1) {
                                    ...
                                    tv_balance_hine.setText(ToolsUtils.returnXMLStr("amount_of_the_remaining_stored") + userStored + "(￥)");
                                    order_money.setText(ToolsUtils.returnXMLStr("wating_pay_money") + memberMoney.toString());
                                    tv_credit_hine.setText(ToolsUtils.returnXMLStr("intergral_of_the_remaining_stored") + account.getCredit());
                                    member_info.setText(ToolsUtils.returnXMLStr("member_card_number_xx2") + account.getUno() + "  " + ToolsUtils.returnXMLStr("phoneNumber") + "  " + account.getPhone() + "  " + ToolsUtils.returnXMLStr("sth_name2") + "  " + account.getName() + ToolsUtils.logicUserCardGender(account) + "  " + ToolsUtils.returnXMLStr("grade") + "  " + account.getGradeName());
                                    ...
                                    if (accountMemberInfo[0] != null) {
                                        ...
                                        EventBus.getDefault().post(new PosEvent(Constant.EventState.MEMBER_INFO_CHANGE));
                                    }
                                    ...
                                    final int[] current = {-1};
                                    lv_memberCard.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        @Override
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            current[0] = position;
                                    ...
                                    tv_sure.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (current[0] != -1) {
                                                ...
                                                MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_select_member_card"));
                                            }
                                        }
                                    });
                                }
                                ...
                                wsh_warn.setVisibility(View.VISIBLE);
                                rel_selectMemberCard.setVisibility(View.GONE);
                                wsh_warn.setText(ToolsUtils.returnXMLStr("this_number_is_not_member"));
                            }
                        }
            ...
            public void creatDeal() {
                ...
                if (orderItems != null && orderItems.size() > 0) {
                    ...
                    for (OrderItem orderItem : orderItems) {
                        ...
                        pruduct.price = orderItem.getPrice().subtract(new BigDecimal(100)).intValue();//传的是分
                ...
                try {
                    if (!TextUtils.isEmpty(balanceStr)) {
                        ...
                        BigDecimal bdd = bd.divide(new BigDecimal("100"), 2, BigDecimal.ROUND_HALF_UP);
                        Payment payment = new Payment(storedId, ToolsUtils.returnXMLStr("member_stored_value"), bdd.floatValue());
                    ...
                    e.printStackTrace();
                    MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_input_correct_stored_value"));
                    return;
                }
                //                }
                ...
                if (coupons != null && coupons.size() > 0) {
                    ...
                    for (WshAccountCoupon coupon : coupons) {
                        ...
                        for (int i = 0; i < Math.min(coupon.getSelectCount(), coupon.getCoupon_ids().size()); i++) {
                            dinos.add(coupon.getCoupon_ids().get(i));
                        }
                    }
                    Payment payment = new Payment(vouchersId, ToolsUtils.returnXMLStr("coupon"), money);
                    memberPayMent.add(payment);
                ...
                try {
                    if (!TextUtils.isEmpty(creditStr)) {
                        ...
                        Payment payment = new Payment(integralId, ToolsUtils.returnXMLStr("member_intergrals"), Integer.parseInt(creditStr));
                        memberPayMent.add(payment);
                ...
                if (isCanCreat4) {
                    request.setConsume_amount(memberMoney.multiply(new BigDecimal("100")).intValue());
                    BigDecimal paymentAmount = memberMoney.multiply(new BigDecimal("100")).subtract(new BigDecimal(consumAmount));
                    ...
                    request.setPayment_amount(memberMoney.multiply(new BigDecimal("100")).intValue());
                    request.setConsume_amount(memberMoney.multiply(new BigDecimal("100")).intValue());
                }
                ...
                if (isCanCreat1 == false && isCanCreat2 == false && isCanCreat3 == false || isCanCreat4) {
                    ...
                    try {
                        ...
                        wshService.createDeal(request, new ResultCallback<WshDealPreview>() {
                            ...
                            public void onResult(WshDealPreview result) {
                                progressDialog.disLoading();
                                BigDecimal print_money = new BigDecimal(request.getConsume_amount() / 100.0).setScale(2, BigDecimal.ROUND_HALF_UP);
                                if (isCheckBalance && finalIsCanCreat4)//需要结算订单剩下的全部余额
                                {
                                    if (print_money.compareTo(memberMoney) == -1) {
                                        MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_enter_a_valid_amount"));
                                        return;
                                    }
                                }
                                dialog.dismiss();
                                if (finalIsCanCreat1 == false && finalIsCanCreat2 == false && finalIsCanCreat3 == false) {
                                    if (!isCheckBalance) {
                                        ...
                                        creatDealBack.onDeal(bis_id, result, print_money.setScale(2, BigDecimal.ROUND_HALF_UP), false, accountMemberInfo[0], memberPayMent);
                                    }
                                    //                                    creatDealBack.onDeal(bis_id, result, new BigDecimal(finalConsumAmount / 100.0).setScale(2, BigDecimal.ROUND_HALF_UP), false, accountMemberInfo[0], memberPayMent);

                                } else {
                                    creatDealBack.onDeal(bis_id, result, new BigDecimal(finalConsumAmount / 100.0).setScale(2, BigDecimal.ROUND_HALF_UP), true, accountMemberInfo[0], memberPayMent);
                                }
                            }
                    ...
                    MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_select_valid_member_pay"));
                }
            }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (KeyEvent.KEYCODE_ENTER == keyCode && KeyEvent.ACTION_DOWN == event.getAction()) {
                    if (!TextUtils.isEmpty(cardno.getText().toString().trim())) {
                        ...
                        if (TextUtils.isEmpty(num)) {
                            MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("sth_member_number_hine"));
                        } else {
                            WindowUtil.hiddenKey();
        ...
        checkmember.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String num = cardno.getText().toString().trim();
                if (TextUtils.isEmpty(num)) {
                    MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_input_member_number"));
                    return;
                }
                member.getMemberInfo(num);
            }
        ...
        use.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Cart.getDishItemList() != null && Cart.getDishItemList().size() > 0) {
                    ...
                    MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_click_dish"));
                }
        ...
        cancel_saveMember.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (accountMemberInfo[0] != null) {
                    ...
                    MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_input_correct_member_info"));
                }
            }
        });
        return dialog;
    ...
    public static void aboutStoreDialog(Context context, TerminalInfo terminalInfo, final DialogCallback dialogCallback) {
        ...
        tv_terminalInfo.setText("appId:" + terminalInfo.appid + "  brandId:" + terminalInfo.brandid + "  storeId:" + terminalInfo.storeid);
        ...
        et_member.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (cardNo.contains("\n") || cardNo.contains("\r")) {
                    ...
                    if (balance == null) {
                        tv_card_no.setText(ToolsUtils.returnXMLStr("card_numb") + ToolsUtils.returnXMLStr("not_find_info"));
                    ...
                    if (subtract.compareTo(new BigDecimal(0)) < 0) {
                        tv_balance.setText(ToolsUtils.returnXMLStr("balance") + balance + "￥,  " + ToolsUtils.returnXMLStr("insufficient_balance"));
                        return;
                    }
                    tv_card_no.setTag(1);
    ...
    public static Dialog showQuarters(final Context context, final List<Staff> staffList, final DialogTCallback dialogCall) {
        ...
        ScrolListView lv_staffQuarters = (ScrolListView) dialog.findViewById(R.id.lv_staffQuarters);
        final ComTextView wsh_close = (ComTextView) dialog.findViewById(R.id.wsh_close);
        final TextView tv_sure = (TextView) dialog.findViewById(R.id.tv_sure);
        wsh_close.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public static Dialog aboutCloudPos(final Context context) {
        ...
        device_isInternet.setText(TextUtils.isEmpty(wifiId) ? ToolsUtils.returnXMLStr("not_connect") : ToolsUtils.returnXMLStr("connect"));
    ...
    public static Dialog createSingleButtonDialog(Context context, String title, final DialogTCallback dialogTCallback) {
        ...
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_three_button, 0.5f, 0.3f);
        TextView printTitle = (TextView) dialog.findViewById(R.id.print_title);
        TextView tv_standby_money = (TextView) dialog.findViewById(R.id.tv_standby_money);
        final CommonEditText ed_standby_moneyEnd = (CommonEditText) dialog.findViewById(R.id.ed_standby_money);
        TextView negativeButtonEnd = (TextView) dialog.findViewById(R.id.print_ok);
        TextView positiveButtonEnd = (TextView) dialog.findViewById(R.id.print_cancle);
        TextView zeroButtonEnd = (TextView) dialog.findViewById(R.id.print_zero);
        LinearLayout print_close_ll = (LinearLayout) dialog.findViewById(R.id.print_close_ll);
        final Store store = Store.getInstance(context);
        ...
        class WeightInfor implements WeightCallBack {
            ...
            public void setTareNumSuccess(boolean state) {
                if (state && isConfirm[0]) {
                    try {
                        float weight = Float.valueOf(ed_standby_moneyEnd.getText().toString().trim().replace(unit, ""));
                        if (weight < 0) {
                            MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_enter_it_correctly"));
                            return;
                        }
    ...
    public static Dialog dishWeight(Context context, final Dish dish, final DialogTCallback dialogTCallback) {
        ...
        TextView printTitle = (TextView) dialog.findViewById(R.id.print_title);
        final CommonEditText ed_dish_netWeight = (CommonEditText) dialog.findViewById(R.id.ed_dish_netWeight);
        TextView print_cancle = (TextView) dialog.findViewById(R.id.print_cancle);
        TextView print_ok = (TextView) dialog.findViewById(R.id.print_ok);
        ...
        tv_weight_hine.setText(ToolsUtils.returnXMLStr("isSetTareNums") + store.getTareWeight() + "/kg");
        ...
        print_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    float weight = Float.valueOf(ed_dish_netWeight.getText().toString().trim());
                    if (weight < 0) {
                        MyApplication.getInstance().ShowToast(ToolsUtils.returnXMLStr("please_input_correct_money"));
                        return;
                    }
        ...
        class WeightInfor implements WeightCallBack {
            ...
            @Override
            public void changeNetWeight(float netWeight) {
                BigDecimal cost = dish.getPrice().multiply(new BigDecimal(String.valueOf(netWeight))).setScale(2, BigDecimal.ROUND_DOWN);
    ...
    public static Dialog revokeInvoiceDialog(final Context context, final DialogTCallback dialogTCallback) {
        ...
        final Dialog dialog = DialogUtil.getDialog(context, R.layout.dialog_revoke_invoice, 0.9f, 0.5f);
        dialog.setCanceledOnTouchOutside(false);
        TextView tv_back = (TextView) dialog.findViewById(R.id.tv_back);
        TextView tv_ok = (TextView) dialog.findViewById(R.id.tv_ok);
