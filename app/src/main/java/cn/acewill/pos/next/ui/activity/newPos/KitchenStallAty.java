 ...
 */
public class KitchenStallAty extends BaseActivity {
    ...
    private KitchenStall kitchenStall;
    private String KdsName;
    private String KdsIp;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentXml(R.layout.aty_kitchenstall_info);
    ...
    private void initView() {
        myApplication.addPage(KitchenStallAty.this);
        setTitle("KDS");
        setShowBtnBack(true);
        setRightText(ToolsUtils.returnXMLStr("setting_save"));
        kitchenStall = (KitchenStall) getIntent().getSerializableExtra("kitchenStall");
//        if (kitchenStall == null) {
//            deleteKds.setVisibility(View.GONE);
//        } else {
//            deleteKds.setVisibility(View.VISIBLE);
//            printerName.setText(kitchenStall.getKdsName());
//            printerIp.setText(kitchenStall.getIp());
//        }
    }
...
//                    if (kds != null) {
//                        DialogUtil.ordinaryDialog(context, "删除打印机", "是否要删除KDS (" + kds.getKdsName() + ") ？", new DialogCallback() {
//                            @Override
